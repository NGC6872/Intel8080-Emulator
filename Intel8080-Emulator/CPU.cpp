    ...
    void CPU::Step() {
        ...
        switch (opCode) {
            ...
            case 0x34: { // INR M => (HL) = (HL) + 1, set flags
                ...
                FLAGS.P = Parity(Memory[offset], 8);
            ...
            case 0x86: {
                ...
                unsigned short result = (unsigned short)A + Memory[pair_HL];

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (Memory[pair_HL] & 0xf)) > 0xf);
            ...
            case 0x88: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)B + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (B & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x89: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)C + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (C & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8a: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)D + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (D & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8b: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)E + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (E & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8c: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)H + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (H & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8d: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)L + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (L & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8e: {
                ...
                unsigned short result = (unsigned short)A + Memory[pair_HL] + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (Memory[pair_HL] & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x8f: {
                ...
                unsigned short result = (unsigned short)A + (unsigned short)A + FLAGS.C;

                SetArithmeticFlags(result);

                // Set aux carry flag

                FLAGS.A = (((A & 0xf) + (A & 0xf) + FLAGS.C) > 0xf);
            ...
            case 0x96: {
                ...
                FLAGS.A = (((A & 0xf) + (-(Memory[result]) & 0xf)) > 0xf);
